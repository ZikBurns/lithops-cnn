...
from lithops.serverless.backends.aws_lambda_custom_image.custom_code.function import lambda_function
...
def lambda_handler(event, context):
    ...
    elif (event['config']['lithops']['backend'] == 'aws_lambda_custom_image'):
